        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                if (!empty($_SESSION['cart'])) {
                    foreach ($_SESSION['cart'] as $item) {
                        ...
                        echo "<tr>
                            ...
                            <td>{$item['quantity']}</td>
                            <td>{$item_total}€</td>
                            <td><a href='remove_from_cart.php?id_product={$item['id_product']}' class='btn btn-danger'>Supprimer</a></td>
                        </tr>";
                    }
                } else {
                ...
                <tr>
                    ...
                    <td><a href="checkout.php" class="btn btn-primary">Passer la commande</a></td>
                </tr>
            </tbody>
        </table>
    </div>
